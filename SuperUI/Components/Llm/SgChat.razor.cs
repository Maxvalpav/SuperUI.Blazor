...
public partial class SgChat : ComponentBase, IAsyncDisposable
{
    ...
    private SgLlmConfig _config = new()
    {
        ...
        ApiKey = "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"
    };

    private List<SgLlmModelInfo> _openRouterModels = new();
    private string _manualModelId = "";
    private bool _useManualModel;
    ...
    private void ToggleSettings()
    {
        ...
        if (_showSettings && _config.Provider == SgLlmProvider.OpenRouter && _openRouterModels.Count == 0)
        {
            _ = LoadOpenRouterModelsAsync();
        }
    }
    ...
    private async Task InitializeAsync()
    {
        ...
        try
        {
            if (_useManualModel && !string.IsNullOrWhiteSpace(_manualModelId))
            {
                _config.ModelId = _manualModelId;
            }

            await LlmService.InitializeAsync(_config);
            _isReady = true;
            _showSettings = false;
        }
        catch (Exception ex)
