...
/// <summary>Column-alignment flag used by <see cref="Components.SgTableColumn{TItem}"/> to mark fine-grained status granules.</summary>
public enum SgColumnAlign { Default, Left, Center, Right }

/// <summary>Horizontal text alignment for a <see cref="Components.SgDataGridColumn{TItem}"/> cell and header.</summary>
...
/// <summary>Vertical alignment for a <see cref="Components.SgDataGridColumn{TItem}"/> cell.</summary>
