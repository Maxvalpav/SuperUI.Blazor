...
/// <summary>
/// Neo — Gen Z electric blue + hot pink. Bold, expressive, chunky.
/// Electric blue primary with hot pink success and cyan info accents.
/// </summary>
public sealed class NeoTheme : ThemeBase
{
    public override string Id => "neo";
    public override string Name => "Neo";
    public override string? Description => "Gen Z electric blue + hot pink. Bold, expressive, chunky radii and touch targets.";
    public override string? Author => "SuperUI";
    public override string Version => "1.0.0";
    public override string Category => "Persona";

    protected override IThemePrimitives CreatePrimitives() => new NeoPrimitives();
    protected override IThemeSemantic CreateLight() => new NeoSemanticLight();
    protected override IThemeSemantic? CreateDark() => new NeoSemanticDark();
    protected override IThemeComponents? CreateComponents() => new NeoComponents();
    protected override IThemeTypography? CreateTypography() => new NeoTypography();
    ...
    public override string? AdditionalCss => $$"""
        ...
        [data-theme-id="neo"] .sgc-btn {
            border-width: 2px;
        }

        @media (prefers-reduced-motion: reduce) {
            [data-theme-id="neo"] *,
            [data-theme-id="neo"] *::before,
            [data-theme-id="neo"] *::after {
...
internal class NeoPrimitives : IThemePrimitives
{
    private const double Hue = 220;
    ...
    public virtual string Success50  => "oklch(0.95 0.035 330)";
    public virtual string Success100 => "oklch(0.88 0.07 330)";
    public virtual string Success500 => "oklch(0.58 0.16 330)";
    public virtual string Success600 => "oklch(0.50 0.16 330)";
    public virtual string Success700 => "oklch(0.42 0.15 330)";
    ...
    public virtual string RadiusLg   => "18px";
    public virtual string RadiusXl   => "28px";
    public virtual string Radius2Xl  => "40px";
    public virtual string RadiusFull => "9999px";
}

internal class NeoSemanticLight : BaseLightConsistent
{
    public NeoSemanticLight() : base(220) { }

    public override string BgDefault     => "oklch(0.985 0.005 220)";
    public override string BgSubtle      => "oklch(0.96 0.008 220)";
    public override string BgMuted       => "oklch(0.93 0.012 220)";
    public override string BgEmphasized  => "oklch(0.88 0.016 220)";
    public override string BgOverlay     => "oklch(0.16 0.02 220 / 0.40)";
    public override string BgGlass       => "oklch(0.985 0.005 220 / 0.7)";
    ...
    public override string FgInverse   => "oklch(0.985 0.005 220)";
    public override string FgLink      => "oklch(0.56 0.24 220)";
    public override string FgLinkHover => "oklch(0.50 0.24 220)";
    ...
    public override string BorderFocus   => "oklch(0.56 0.24 220)";
    public override string Divider       => "oklch(0.93 0.01 220)";

    public override string ColorPrimary        => "oklch(0.56 0.24 220)";
    public override string ColorPrimaryHover   => "oklch(0.50 0.24 220)";
    public override string ColorPrimaryActive  => "oklch(0.44 0.23 220)";
    public override string ColorPrimarySubtle  => "oklch(0.93 0.05 220)";
    public override string ColorPrimaryMuted   => "oklch(0.84 0.10 220)";

    public override string ColorSuccess        => "oklch(0.56 0.20 330)";
    public override string ColorSuccessHover   => "oklch(0.50 0.20 330)";
    public override string ColorSuccessSubtle  => "oklch(0.94 0.04 330)";
    ...
    public override string FocusRing       => "0 0 0 2px oklch(0.985 0.005 220), 0 0 0 4px oklch(0.56 0.24 220)";
    public override string FocusRingDanger => "0 0 0 2px oklch(0.985 0.005 220), 0 0 0 4px oklch(0.55 0.20 19)";
}

internal class NeoSemanticDark : BaseDarkConsistent
{
    public NeoSemanticDark() : base(220) { }

    public override string ColorPrimary        => "oklch(0.66 0.24 220)";
    public override string ColorPrimarySubtle  => "oklch(0.20 0.06 220)";
    public override string ColorPrimaryMuted   => "oklch(0.28 0.10 220)";
    public override string ColorPrimaryHover   => "oklch(0.72 0.22 220)";
    public override string ColorPrimaryActive  => "oklch(0.59 0.24 220)";
    public override string ColorPrimaryFg      => "oklch(0.10 0.012 220)";

    public override string ColorSuccess        => "oklch(0.66 0.20 330)";
    public override string ColorSuccessSubtle  => "oklch(0.20 0.05 330)";
    public override string ColorSuccessHover   => "oklch(0.72 0.18 330)";
    public override string ColorSuccessFg      => "oklch(0.95 0.005 220)";

    public override string ColorInfo           => "oklch(0.62 0.18 190)";
    public override string ColorInfoSubtle     => "oklch(0.20 0.05 190)";
    public override string ColorInfoHover      => "oklch(0.68 0.16 190)";
    public override string ColorInfoFg         => "oklch(0.95 0.005 220)";
...
internal class NeoComponents : BaseComponents
{
    ...
    public override string InputRadius   => "8px";
    public override string InputHeight   => "40px";
    public override string InputHeightSm => "32px";
    public override string InputHeightLg => "48px";

    public override string CardRadius    => "12px";
    public override string ModalRadius   => "12px";
    public override string TableRadius   => "10px";
}

internal sealed class NeoTypography : IThemeTypography
{
    public string GoogleFontsImportUrl => "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap";
