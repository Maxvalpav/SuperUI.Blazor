...
internal class InclusSemanticLight : IThemeSemantic
{
    // Light — чистый, сбалансированный
    public virtual string BgDefault     => "oklch(0.99 0.003 50)";
    public virtual string BgSubtle      => "oklch(0.97 0.005 50)";
    public virtual string BgMuted       => "oklch(0.935 0.008 50)";
    public virtual string BgEmphasized  => "oklch(0.89 0.012 50)";
    public virtual string BgOverlay     => "oklch(0.16 0.02 50 / 0.40)";
    public virtual string BgGlass       => "oklch(0.99 0.003 50 / 0.7)";
    public virtual string BorderGlass   => "oklch(0.87 0.015 50 / 0.3)";
    ...
    public virtual string FgDefault   => "oklch(0.14 0.015 50)";
    public virtual string FgSubtle    => "oklch(0.36 0.012 50)";
    public virtual string FgMuted     => "oklch(0.52 0.01 50)";
    public virtual string FgDisabled  => "oklch(0.68 0.008 50)";
    public virtual string FgInverse   => "oklch(0.99 0.003 50)";
    public virtual string FgLink      => "oklch(0.58 0.14 260)";
    public virtual string FgLinkHover => "oklch(0.52 0.14 260)";

    public virtual string BorderDefault => "oklch(0.87 0.012 50)";
    public virtual string BorderSubtle  => "oklch(0.93 0.01 50)";
    public virtual string BorderStrong  => "oklch(0.80 0.015 50)";
    public virtual string BorderFocus   => "oklch(0.58 0.14 260)";
    public virtual string Divider       => "oklch(0.93 0.01 50)";

    public virtual string ColorPrimary        => "oklch(0.58 0.14 260)";  // blue
    public virtual string ColorPrimarySubtle  => "oklch(0.94 0.035 260)";
    public virtual string ColorPrimaryMuted   => "oklch(0.85 0.07 260)";
    public virtual string ColorPrimaryHover   => "oklch(0.52 0.14 260)";
    public virtual string ColorPrimaryActive  => "oklch(0.46 0.13 260)";
    public virtual string ColorPrimaryFg      => "oklch(0.99 0 0)";

    public virtual string ColorSuccess        => "oklch(0.60 0.12 200)";  // teal, not green
    public virtual string ColorSuccessSubtle  => "oklch(0.94 0.03 200)";
    public virtual string ColorSuccessHover   => "oklch(0.54 0.12 200)";
    public virtual string ColorSuccessFg      => "oklch(0.99 0 0)";

    public virtual string ColorDanger         => "oklch(0.60 0.18 40)";  // orange, not red
    public virtual string ColorDangerSubtle   => "oklch(0.94 0.06 40)";
    public virtual string ColorDangerHover    => "oklch(0.54 0.18 40)";
    public virtual string ColorDangerFg       => "oklch(0.99 0 0)";

    public virtual string ColorWarning        => "oklch(0.74 0.14 100)"; // yellow
    public virtual string ColorWarningSubtle  => "oklch(0.96 0.05 100)";
    public virtual string ColorWarningHover   => "oklch(0.68 0.14 100)";
    public virtual string ColorWarningFg      => "oklch(0.14 0.015 50)";

    public virtual string ColorInfo           => "oklch(0.58 0.14 260)"; // blue
    public virtual string ColorInfoSubtle     => "oklch(0.94 0.035 260)";
    public virtual string ColorInfoHover      => "oklch(0.52 0.14 260)";
    ...
    public virtual string ShadowXs => "0 1px 1px 0 oklch(0.14 0.015 50 / 0.04)";
    public virtual string ShadowSm => "0 1px 2px 0 oklch(0.14 0.015 50 / 0.06), 0 1px 1px -1px oklch(0.14 0.015 50 / 0.06)";
    public virtual string ShadowMd => "0 2px 4px -1px oklch(0.14 0.015 50 / 0.08), 0 1px 2px -1px oklch(0.14 0.015 50 / 0.06)";
    public virtual string ShadowLg => "0 8px 16px -4px oklch(0.14 0.015 50 / 0.10), 0 2px 4px -2px oklch(0.14 0.015 50 / 0.06)";
    public virtual string ShadowXl => "0 16px 32px -8px oklch(0.14 0.015 50 / 0.14), 0 4px 8px -4px oklch(0.14 0.015 50 / 0.08)";
    ...
    public virtual string FocusRing       => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.58 0.14 260)";
    public virtual string FocusRingDanger => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.60 0.18 40)";
...
internal class InclusSemanticDark : IThemeSemantic
{
    // Dark — высокий контраст, различимость для всех CVD
    public virtual string BgDefault     => "oklch(0.10 0.01 50)";
    public virtual string BgSubtle      => "oklch(0.18 0.015 50)";
    public virtual string BgMuted       => "oklch(0.15 0.012 50)";
    public virtual string BgEmphasized  => "oklch(0.22 0.018 50)";
    public virtual string BgOverlay     => "oklch(0 0 0 / 0.72)";
    public virtual string BgGlass       => "oklch(0.10 0.01 50 / 0.7)";
    public virtual string BorderGlass   => "oklch(0.99 0 0 / 0.08)";
    public virtual string BlurGlass     => "16px";

    public virtual string Surface         => "oklch(0.13 0.015 50)";
    public virtual string SurfaceRaised   => "oklch(0.15 0.018 50)";
    public virtual string SurfaceOverlay  => "oklch(0.15 0.018 50)";

    public virtual string FgDefault   => "oklch(0.95 0.003 50)";
    public virtual string FgSubtle    => "oklch(0.82 0.005 50)";
    public virtual string FgMuted     => "oklch(0.62 0.008 50)";
    public virtual string FgDisabled  => "oklch(0.40 0.01 50)";
    public virtual string FgInverse   => "oklch(0.10 0.01 50)";
    public virtual string FgLink      => "oklch(0.65 0.16 260)";
    public virtual string FgLinkHover => "oklch(0.72 0.16 260)";

    public virtual string BorderDefault => "oklch(0.25 0.015 50)";
    public virtual string BorderSubtle  => "oklch(0.18 0.012 50)";
    public virtual string BorderStrong  => "oklch(0.30 0.02 50)";
    public virtual string BorderFocus   => "oklch(0.65 0.16 260)";
    public virtual string Divider       => "oklch(0.18 0.012 50)";

    public virtual string ColorPrimary        => "oklch(0.65 0.16 260)";
    public virtual string ColorPrimarySubtle  => "oklch(0.20 0.05 260)";
    public virtual string ColorPrimaryMuted   => "oklch(0.28 0.08 260)";
    public virtual string ColorPrimaryHover   => "oklch(0.72 0.16 260)";
    public virtual string ColorPrimaryActive  => "oklch(0.59 0.16 260)";
    public virtual string ColorPrimaryFg      => "oklch(0.10 0.01 50)";

    public virtual string ColorSuccess        => "oklch(0.62 0.12 200)"; // teal
    public virtual string ColorSuccessSubtle  => "oklch(0.18 0.04 200)";
    public virtual string ColorSuccessHover   => "oklch(0.68 0.12 200)";
    public virtual string ColorSuccessFg      => "oklch(0.95 0.003 50)";

    public virtual string ColorDanger         => "oklch(0.64 0.18 40)";  // orange
    public virtual string ColorDangerSubtle   => "oklch(0.20 0.06 40)";
    public virtual string ColorDangerHover    => "oklch(0.70 0.18 40)";
    public virtual string ColorDangerFg       => "oklch(0.95 0.003 50)";

    public virtual string ColorWarning        => "oklch(0.78 0.14 100)"; // yellow
    public virtual string ColorWarningSubtle  => "oklch(0.22 0.05 100)";
    public virtual string ColorWarningHover   => "oklch(0.84 0.12 100)";
    public virtual string ColorWarningFg      => "oklch(0.10 0.01 50)";

    public virtual string ColorInfo           => "oklch(0.65 0.16 260)"; // blue
    public virtual string ColorInfoSubtle     => "oklch(0.20 0.05 260)";
    public virtual string ColorInfoHover      => "oklch(0.72 0.16 260)";
    public virtual string ColorInfoFg         => "oklch(0.95 0.003 50)";
    ...
    public virtual string FocusRing       => "0 0 0 2px oklch(0.10 0.01 50), 0 0 0 4px oklch(0.65 0.16 260)";
    public virtual string FocusRingDanger => "0 0 0 2px oklch(0.10 0.01 50), 0 0 0 4px oklch(0.64 0.18 40)";
