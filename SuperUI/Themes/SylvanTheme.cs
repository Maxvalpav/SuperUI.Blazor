...
internal class SylvanSemanticDark : IThemeSemantic
{
    // Dark — «Подлесок»
    public virtual string BgDefault     => "oklch(0.08 0.015 135)";
    public virtual string BgSubtle      => "oklch(0.16 0.02 135)";
    public virtual string BgMuted       => "oklch(0.12 0.018 135)";
    public virtual string BgEmphasized  => "oklch(0.20 0.025 135)";
    public virtual string BgOverlay     => "oklch(0 0 0 / 0.65)";
    public virtual string BgGlass       => "oklch(0.08 0.015 135 / 0.7)";
    public virtual string BorderGlass   => "oklch(0.99 0 0 / 0.06)";
    public virtual string BlurGlass     => "16px";

    public virtual string Surface         => "oklch(0.12 0.02 135)";
    public virtual string SurfaceRaised   => "oklch(0.14 0.025 135)";
    public virtual string SurfaceOverlay  => "oklch(0.14 0.025 135)";

    public virtual string FgDefault   => "oklch(0.93 0.008 135)";
    public virtual string FgSubtle    => "oklch(0.80 0.01 135)";
    public virtual string FgMuted     => "oklch(0.60 0.015 135)";
    public virtual string FgDisabled  => "oklch(0.38 0.015 135)";
    public virtual string FgInverse   => "oklch(0.08 0.015 135)";
    public virtual string FgLink      => "oklch(0.65 0.16 135)";
    public virtual string FgLinkHover => "oklch(0.72 0.16 135)";

    public virtual string BorderDefault => "oklch(0.22 0.025 35)";
    public virtual string BorderSubtle  => "oklch(0.15 0.02 35)";
    public virtual string BorderStrong  => "oklch(0.28 0.03 35)";
    public virtual string BorderFocus   => "oklch(0.65 0.16 135)";
    public virtual string Divider       => "oklch(0.15 0.02 35)";

    public virtual string ColorPrimary        => "oklch(0.65 0.16 135)";
    public virtual string ColorPrimarySubtle  => "oklch(0.20 0.06 135)";
    public virtual string ColorPrimaryMuted   => "oklch(0.28 0.09 135)";
    public virtual string ColorPrimaryHover   => "oklch(0.72 0.16 135)";
    public virtual string ColorPrimaryActive  => "oklch(0.59 0.16 135)";
    public virtual string ColorPrimaryFg      => "oklch(0.08 0.015 135)";

    public virtual string ColorSuccess        => "oklch(0.60 0.12 145)";
    public virtual string ColorSuccessSubtle  => "oklch(0.18 0.04 145)";
    public virtual string ColorSuccessHover   => "oklch(0.66 0.12 145)";
    public virtual string ColorSuccessFg      => "oklch(0.93 0.008 135)";

    public virtual string ColorDanger         => "oklch(0.60 0.18 15)";
    public virtual string ColorDangerSubtle   => "oklch(0.20 0.06 15)";
    public virtual string ColorDangerHover    => "oklch(0.66 0.18 15)";
    public virtual string ColorDangerFg       => "oklch(0.93 0.008 135)";

    public virtual string ColorWarning        => "oklch(0.74 0.14 50)";
    public virtual string ColorWarningSubtle  => "oklch(0.22 0.05 50)";
    public virtual string ColorWarningHover   => "oklch(0.80 0.12 50)";
    public virtual string ColorWarningFg      => "oklch(0.08 0.015 135)";

    public virtual string ColorInfo           => "oklch(0.62 0.14 210)";
    public virtual string ColorInfoSubtle     => "oklch(0.20 0.04 210)";
    public virtual string ColorInfoHover      => "oklch(0.68 0.13 210)";
    public virtual string ColorInfoFg         => "oklch(0.93 0.008 135)";
    ...
    public virtual string FocusRing       => "0 0 0 2px oklch(0.08 0.015 135), 0 0 0 4px oklch(0.65 0.16 135)";
    public virtual string FocusRingDanger => "0 0 0 2px oklch(0.08 0.015 135), 0 0 0 4px oklch(0.60 0.18 15)";
