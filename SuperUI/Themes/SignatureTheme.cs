...
internal class SignatureSemanticLight : BaseLightConsistent
{
    public SignatureSemanticLight() : base(230) { }

    // Creamy warm bg (hue 45°), navy blue primary (hue 230°)
    public override string BgDefault     => "oklch(0.99 0.005 45)";
    public override string BgSubtle      => "oklch(0.97 0.008 45)";
    public override string BgMuted       => "oklch(0.935 0.012 45)";
    public override string BgEmphasized  => "oklch(0.89 0.016 45)";
    public override string BgOverlay     => "oklch(0.16 0.02 45 / 0.40)";
    public override string BgGlass       => "oklch(0.99 0.005 45 / 0.7)";
    public override string BorderGlass   => "oklch(0.87 0.015 45 / 0.3)";

    public override string FgDefault   => "oklch(0.14 0.02 45)";
    public override string FgSubtle    => "oklch(0.36 0.015 45)";
    public override string FgMuted     => "oklch(0.52 0.012 45)";
    public override string FgDisabled  => "oklch(0.68 0.008 45)";
    public override string FgInverse   => "oklch(0.99 0.005 45)";
    public override string FgLink      => "oklch(0.58 0.12 230)";
    public override string FgLinkHover => "oklch(0.52 0.12 230)";

    public override string BorderDefault => "oklch(0.87 0.012 45)";
    public override string BorderSubtle  => "oklch(0.93 0.01 45)";
    public override string BorderStrong  => "oklch(0.80 0.015 45)";
    public override string BorderFocus   => "oklch(0.58 0.12 230)";
    public override string Divider       => "oklch(0.93 0.01 45)";

    public override string ColorPrimary        => "oklch(0.58 0.12 230)";
    public override string ColorPrimaryMuted   => "oklch(0.85 0.07 230)";
    public override string ColorPrimaryHover   => "oklch(0.52 0.12 230)";
    public override string ColorPrimaryActive  => "oklch(0.46 0.11 230)";

    public override string ColorDanger         => "oklch(0.55 0.18 10)";
    public override string ColorDangerHover    => "oklch(0.50 0.18 10)";

    public override string ColorWarning        => "oklch(0.70 0.14 50)";
    public override string ColorWarningHover   => "oklch(0.64 0.14 50)";
    public override string ColorWarningFg      => "oklch(0.14 0.02 45)";
    ...
    public override string FocusRing       => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.58 0.12 230)";
    public override string FocusRingDanger => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.55 0.18 10)";
}
