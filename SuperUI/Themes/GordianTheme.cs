...
internal class GordianSemanticLight : BaseLightConsistent
{
    public GordianSemanticLight() : base(300) { }

    // Purple-tinted bg (hue 300°), blue primary (hue 230°)
    public override string BgDefault     => "oklch(0.99 0.003 300)";
    public override string BgSubtle      => "oklch(0.97 0.005 300)";
    public override string BgMuted       => "oklch(0.935 0.008 300)";
    public override string BgEmphasized  => "oklch(0.89 0.012 300)";
    public override string BgOverlay     => "oklch(0.16 0.02 300 / 0.40)";
    public override string BgGlass       => "oklch(0.99 0.003 300 / 0.7)";
    public override string BorderGlass   => "oklch(0.87 0.015 300 / 0.3)";

    public override string FgDefault   => "oklch(0.14 0.015 300)";
    public override string FgSubtle    => "oklch(0.36 0.012 300)";
    public override string FgMuted     => "oklch(0.52 0.01 300)";
    public override string FgDisabled  => "oklch(0.68 0.008 300)";
    public override string FgInverse   => "oklch(0.99 0.003 300)";
    public override string FgLink      => "oklch(0.58 0.16 230)";
    public override string FgLinkHover => "oklch(0.52 0.16 230)";
    ...
    public override string BorderFocus   => "oklch(0.58 0.16 230)";
    public override string Divider       => "oklch(0.93 0.01 300)";

    public override string ColorPrimary        => "oklch(0.58 0.16 230)";
    public override string ColorPrimaryMuted   => "oklch(0.85 0.09 230)";
    public override string ColorPrimaryHover   => "oklch(0.52 0.16 230)";
    public override string ColorPrimaryActive  => "oklch(0.46 0.15 230)";

    // Golden success (hue 50°), not green
    public override string ColorSuccess        => "oklch(0.58 0.16 50)";
    public override string ColorSuccessHover   => "oklch(0.52 0.16 50)";

    public override string ColorDanger         => "oklch(0.55 0.20 320)";
    public override string ColorDangerHover    => "oklch(0.50 0.20 320)";

    public override string ColorWarning        => "oklch(0.70 0.18 5)";
    public override string ColorWarningHover   => "oklch(0.64 0.18 5)";

    public override string ColorInfo           => "oklch(0.58 0.15 275)";
    public override string ColorInfoHover      => "oklch(0.52 0.15 275)";
    ...
    public override string RadiusSm   => "5px";
    public override string RadiusMd   => "9px";
    public override string RadiusLg   => "14px";
    public override string RadiusXl   => "22px";
    ...
    public override string FocusRing       => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.58 0.16 230)";
    public override string FocusRingDanger => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.55 0.20 320)";
}
