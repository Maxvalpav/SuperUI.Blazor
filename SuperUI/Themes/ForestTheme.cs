...
internal class ForestSemanticDark : BaseDarkConsistent
{
    public ForestSemanticDark() : base(165) { }

    public override string ColorPrimary        => "oklch(0.65 0.16 165)";
    public override string ColorPrimarySubtle  => "oklch(0.20 0.05 165)";
    public override string ColorPrimaryMuted   => "oklch(0.28 0.08 165)";
    public override string ColorPrimaryHover   => "oklch(0.72 0.16 165)";
    public override string ColorPrimaryActive  => "oklch(0.59 0.16 165)";
    public override string ColorPrimaryFg      => "oklch(0.10 0.012 165)";
    ...
    public override string ColorSuccessFg      => "oklch(0.95 0.005 165)";

    public override string ColorDanger         => "oklch(0.58 0.18 15)";
    public override string ColorDangerSubtle   => "oklch(0.20 0.05 15)";
    public override string ColorDangerHover    => "oklch(0.64 0.18 15)";
    public override string ColorDangerFg       => "oklch(0.95 0.005 165)";

    public override string ColorWarning        => "oklch(0.72 0.12 80)";
    public override string ColorWarningSubtle  => "oklch(0.22 0.04 80)";
    public override string ColorWarningHover   => "oklch(0.78 0.10 80)";
    public override string ColorWarningFg      => "oklch(0.10 0.012 165)";

    public override string ColorInfo           => "oklch(0.60 0.12 200)";
    public override string ColorInfoSubtle     => "oklch(0.20 0.04 200)";
    public override string ColorInfoHover      => "oklch(0.66 0.11 200)";
    public override string ColorInfoFg         => "oklch(0.95 0.005 165)";
}
