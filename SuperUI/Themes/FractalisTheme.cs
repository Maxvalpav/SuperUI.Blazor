...
/// <summary>
/// Fractalis — фрактальная тема на основе рекурсии: Hₙ = Hₙ₋₁ + 137.5° / φⁿ.
/// Каждый semantic цвет — следующая итерация фрактального правила.
/// Dark mode = light mode «приближенный» на 1 итерацию глубже.
/// Self-similarity на всех уровнях.
/// </summary>
public sealed class FractalisTheme : ThemeBase
{
    public override string Id => "fractalis";
    public override string Name => "Fractalis";
    public override string? Description => "Фрактальная тема. Hₙ = Hₙ₋₁ + 137.5°/φⁿ. Self-similar цвета. Dark = zoom на 1 итерацию.";
    public override string? Author => "SuperUI";
    public override string Version => "1.0.0";

    protected override IThemePrimitives CreatePrimitives() => new FractalisPrimitives();
    protected override IThemeSemantic CreateLight() => new FractalisSemanticLight();
    protected override IThemeSemantic? CreateDark() => new FractalisSemanticDark();
    protected override IThemeComponents? CreateComponents() => new FractalisComponents();
    protected override IThemeTypography? CreateTypography() => new FractalisTypography();
    ...
    public override string? AdditionalCss => $$"""
        ...
        @media (prefers-reduced-motion: reduce) {
            [data-theme-id="fractalis"] *,
            [data-theme-id="fractalis"] *::before,
            [data-theme-id="fractalis"] *::after {
...
internal class FractalisPrimitives : IThemePrimitives
{
    ...
    // Fractal recurrence: H₀ = 220°, Hₙ = Hₙ₋₁ + 137.5°/φⁿ
    // H₀ = 220°   Primary
    // H₁ = 357.5°  Danger
    // H₂ = 82.5°   Warning
    // H₃ = 135°    Success
    ...
    // Info at H₄ = 167.5°
    public virtual string Info50  => "oklch(0.95 0.025 167.5)";
    public virtual string Info100 => "oklch(0.88 0.05 167.5)";
    public virtual string Info500 => "oklch(0.58 0.12 167.5)";
    public virtual string Info600 => "oklch(0.50 0.12 167.5)";

    // Warning at H₂ = 82.5°
    public virtual string Warning50  => "oklch(0.97 0.03 82.5)";
    public virtual string Warning100 => "oklch(0.92 0.06 82.5)";
    public virtual string Warning500 => "oklch(0.70 0.14 82.5)";
    public virtual string Warning600 => "oklch(0.62 0.14 82.5)";
    ...
    public virtual string RadiusXl   => "32px";
    public virtual string Radius2Xl  => "64px";
    public virtual string RadiusFull => "9999px";
}

internal class FractalisSemanticLight : IThemeSemantic
{
    public virtual string BgDefault     => "oklch(0.99 0.003 220)";
    public virtual string BgSubtle      => "oklch(0.97 0.005 220)";
    public virtual string BgMuted       => "oklch(0.935 0.008 220)";
    public virtual string BgEmphasized  => "oklch(0.89 0.012 220)";
    public virtual string BgOverlay     => "oklch(0.16 0.02 220 / 0.40)";
    public virtual string BgGlass       => "oklch(0.99 0.003 220 / 0.7)";
    public virtual string BorderGlass   => "oklch(0.87 0.015 220 / 0.3)";
    ...
    public virtual string FgDefault   => "oklch(0.14 0.015 220)";
    public virtual string FgSubtle    => "oklch(0.36 0.012 220)";
    public virtual string FgMuted     => "oklch(0.52 0.01 220)";
    public virtual string FgDisabled  => "oklch(0.68 0.008 220)";
    public virtual string FgInverse   => "oklch(0.99 0.003 220)";
    public virtual string FgLink      => "oklch(0.59 0.14 220)";
    public virtual string FgLinkHover => "oklch(0.53 0.14 220)";

    public virtual string BorderDefault => "oklch(0.87 0.012 220)";
    public virtual string BorderSubtle  => "oklch(0.93 0.01 220)";
    public virtual string BorderStrong  => "oklch(0.80 0.015 220)";
    public virtual string BorderFocus   => "oklch(0.59 0.14 220)";
    public virtual string Divider       => "oklch(0.93 0.01 220)";
    ...
    public virtual string ColorSuccess        => "oklch(0.58 0.12 135)";
    public virtual string ColorSuccessSubtle  => "oklch(0.94 0.03 135)";
    public virtual string ColorSuccessHover   => "oklch(0.52 0.12 135)";
    public virtual string ColorSuccessFg      => "oklch(0.99 0 0)";

    public virtual string ColorDanger         => "oklch(0.55 0.20 357.5)";
    public virtual string ColorDangerSubtle   => "oklch(0.94 0.05 357.5)";
    public virtual string ColorDangerHover    => "oklch(0.50 0.20 357.5)";
    public virtual string ColorDangerFg       => "oklch(0.99 0 0)";

    public virtual string ColorWarning        => "oklch(0.70 0.14 82.5)";
    public virtual string ColorWarningSubtle  => "oklch(0.96 0.04 82.5)";
    public virtual string ColorWarningHover   => "oklch(0.64 0.14 82.5)";
    public virtual string ColorWarningFg      => "oklch(0.14 0.015 220)";

    public virtual string ColorInfo           => "oklch(0.58 0.12 167.5)";
    public virtual string ColorInfoSubtle     => "oklch(0.94 0.03 167.5)";
    public virtual string ColorInfoHover      => "oklch(0.52 0.12 167.5)";
    ...
    public virtual string ShadowXs => "0 1px 1px 0 oklch(0.14 0.015 220 / 0.04)";
    public virtual string ShadowSm => "0 1px 2px 0 oklch(0.14 0.015 220 / 0.06), 0 1px 1px -1px oklch(0.14 0.015 220 / 0.06)";
    public virtual string ShadowMd => "0 2px 4px -1px oklch(0.14 0.015 220 / 0.08), 0 1px 2px -1px oklch(0.14 0.015 220 / 0.06)";
    public virtual string ShadowLg => "0 8px 16px -4px oklch(0.14 0.015 220 / 0.10), 0 2px 4px -2px oklch(0.14 0.015 220 / 0.06)";
    public virtual string ShadowXl => "0 16px 32px -8px oklch(0.14 0.015 220 / 0.14), 0 4px 8px -4px oklch(0.14 0.015 220 / 0.08)";
    ...
    public virtual string FocusRingDanger => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.55 0.20 357.5)";
...
internal class FractalisSemanticDark : IThemeSemantic
{
    // Dark = zoom in one iteration: deeper, more complex
    public virtual string BgDefault     => "oklch(0.10 0.012 220)";
    public virtual string BgSubtle      => "oklch(0.18 0.018 220)";
    public virtual string BgMuted       => "oklch(0.15 0.015 220)";
    public virtual string BgEmphasized  => "oklch(0.22 0.02 220)";
    public virtual string BgOverlay     => "oklch(0 0 0 / 0.72)";
    public virtual string BgGlass       => "oklch(0.10 0.012 220 / 0.7)";
    public virtual string BorderGlass   => "oklch(0.99 0 0 / 0.08)";
    public virtual string BlurGlass     => "16px";

    public virtual string Surface         => "oklch(0.13 0.018 220)";
    public virtual string SurfaceRaised   => "oklch(0.15 0.02 220)";
    public virtual string SurfaceOverlay  => "oklch(0.15 0.02 220)";

    public virtual string FgDefault   => "oklch(0.95 0.005 220)";
    public virtual string FgSubtle    => "oklch(0.82 0.01 220)";
    public virtual string FgMuted     => "oklch(0.62 0.015 220)";
    public virtual string FgDisabled  => "oklch(0.40 0.015 220)";
    public virtual string FgInverse   => "oklch(0.10 0.012 220)";
    public virtual string FgLink      => "oklch(0.65 0.16 220)";
    public virtual string FgLinkHover => "oklch(0.72 0.16 220)";

    public virtual string BorderDefault => "oklch(0.25 0.02 220)";
    public virtual string BorderSubtle  => "oklch(0.18 0.018 220)";
    public virtual string BorderStrong  => "oklch(0.30 0.025 220)";
    public virtual string BorderFocus   => "oklch(0.65 0.16 220)";
    public virtual string Divider       => "oklch(0.18 0.018 220)";
    ...
    public virtual string ColorPrimaryFg      => "oklch(0.10 0.012 220)";

    public virtual string ColorSuccess        => "oklch(0.62 0.12 135)";
    public virtual string ColorSuccessSubtle  => "oklch(0.18 0.035 135)";
    public virtual string ColorSuccessHover   => "oklch(0.68 0.12 135)";
    public virtual string ColorSuccessFg      => "oklch(0.95 0.005 220)";
    ...
    public virtual string ColorDangerFg       => "oklch(0.95 0.005 220)";

    public virtual string ColorWarning        => "oklch(0.74 0.14 82.5)";
    public virtual string ColorWarningSubtle  => "oklch(0.22 0.04 82.5)";
    public virtual string ColorWarningHover   => "oklch(0.80 0.12 82.5)";
    public virtual string ColorWarningFg      => "oklch(0.10 0.012 220)";

    public virtual string ColorInfo           => "oklch(0.62 0.12 167.5)";
    public virtual string ColorInfoSubtle     => "oklch(0.20 0.035 167.5)";
    public virtual string ColorInfoHover      => "oklch(0.68 0.11 167.5)";
    public virtual string ColorInfoFg         => "oklch(0.95 0.005 220)";
    ...
    public virtual string FocusRing       => "0 0 0 2px oklch(0.10 0.012 220), 0 0 0 4px oklch(0.65 0.16 220)";
    public virtual string FocusRingDanger => "0 0 0 2px oklch(0.10 0.012 220), 0 0 0 4px oklch(0.60 0.22 357.5)";
...
internal class FractalisComponents : IThemeComponents
{
    ...
    internal sealed class FractalisTypography : IThemeTypography
    {
        public string GoogleFontsImportUrl => "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=Space+Mono&display=swap";
        ...
        public HeadingSettings H3 => new("1.625rem", HeadingFont, "700", "1.15", "-0.01em");
        public HeadingSettings H4 => new("1.25rem", HeadingFont, "600", "1.2", "0");
        public HeadingSettings H5 => new("1rem", HeadingFont, "600", "1.25", "0");
        public HeadingSettings H6 => new("0.875rem", HeadingFont, "600", "1.3", "0.01em");
    }
