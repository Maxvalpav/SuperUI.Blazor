...
internal class FractalisSemanticLight : BaseLightConsistent
{
    public FractalisSemanticLight() : base(220) { }

    // Cool fractal bg (hue 220°)
    ...
    public override string ColorWarning        => "oklch(0.70 0.14 82.5)";
    public override string ColorWarningHover   => "oklch(0.64 0.14 82.5)";

    public override string ColorInfo           => "oklch(0.58 0.12 167.5)";
    public override string ColorInfoHover      => "oklch(0.52 0.12 167.5)";
    ...
    public override string RadiusMd   => "8px";
    public override string RadiusLg   => "16px";
    public override string RadiusXl   => "32px";
