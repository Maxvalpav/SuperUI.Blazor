...
internal class NeonSemanticLight : IThemeSemantic
{
    // Light — «Ледяной терминал»
    ...
    public virtual string BgOverlay     => "oklch(0.16 0.02 220 / 0.45)";
    public virtual string BgGlass       => "oklch(0.99 0.003 220 / 0.6)";
    ...
    public virtual string FgDefault   => "oklch(0.12 0.02 220)";
    public virtual string FgSubtle    => "oklch(0.34 0.015 220)";
    public virtual string FgMuted     => "oklch(0.50 0.012 220)";
    public virtual string FgDisabled  => "oklch(0.66 0.008 220)";
    public virtual string FgInverse   => "oklch(0.99 0.003 220)";
    public virtual string FgLink      => "oklch(0.57 0.24 200)";
    public virtual string FgLinkHover => "oklch(0.50 0.24 200)";
    ...
    public virtual string BorderFocus   => "oklch(0.57 0.24 200)";
    public virtual string Divider       => "oklch(0.93 0.01 220)";

    public virtual string ColorPrimary        => "oklch(0.57 0.24 200)";
    public virtual string ColorPrimarySubtle  => "oklch(0.94 0.05 200)";
    public virtual string ColorPrimaryMuted   => "oklch(0.85 0.12 200)";
    public virtual string ColorPrimaryHover   => "oklch(0.50 0.24 200)";
    public virtual string ColorPrimaryActive  => "oklch(0.44 0.22 200)";
    public virtual string ColorPrimaryFg      => "oklch(0.99 0 0)";

    public virtual string ColorSuccess        => "oklch(0.58 0.16 160)";
    public virtual string ColorSuccessSubtle  => "oklch(0.94 0.04 160)";
    public virtual string ColorSuccessHover   => "oklch(0.52 0.16 160)";
    public virtual string ColorSuccessFg      => "oklch(0.99 0 0)";

    public virtual string ColorDanger         => "oklch(0.55 0.24 350)";
    public virtual string ColorDangerSubtle   => "oklch(0.94 0.06 350)";
    public virtual string ColorDangerHover    => "oklch(0.50 0.24 350)";
    public virtual string ColorDangerFg       => "oklch(0.99 0 0)";

    public virtual string ColorWarning        => "oklch(0.70 0.20 50)";
    public virtual string ColorWarningSubtle  => "oklch(0.96 0.05 50)";
    public virtual string ColorWarningHover   => "oklch(0.64 0.20 50)";
    public virtual string ColorWarningFg      => "oklch(0.12 0.02 220)";

    public virtual string ColorInfo           => "oklch(0.58 0.18 280)";
    public virtual string ColorInfoSubtle     => "oklch(0.94 0.05 280)";
    public virtual string ColorInfoHover      => "oklch(0.52 0.18 280)";
    ...
    public virtual string TextBase => "0.875rem";
    public virtual string TextLg   => "1.125rem";
    ...
    public virtual string ShadowXs => "0 1px 1px 0 oklch(0.12 0.02 220 / 0.05)";
    public virtual string ShadowSm => "0 1px 2px 0 oklch(0.12 0.02 220 / 0.08), 0 1px 1px -1px oklch(0.12 0.02 220 / 0.06)";
    public virtual string ShadowMd => "0 2px 4px -1px oklch(0.12 0.02 220 / 0.10), 0 1px 2px -1px oklch(0.12 0.02 220 / 0.08)";
    public virtual string ShadowLg => "0 8px 16px -4px oklch(0.12 0.02 220 / 0.12), 0 2px 4px -2px oklch(0.12 0.02 220 / 0.08)";
    public virtual string ShadowXl => "0 16px 32px -8px oklch(0.12 0.02 220 / 0.16), 0 4px 8px -4px oklch(0.12 0.02 220 / 0.10)";
    ...
    public virtual string FocusRing       => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.57 0.24 200)";
    public virtual string FocusRingDanger => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.55 0.24 350)";
...
internal class NeonSemanticDark : IThemeSemantic
{
    // Dark — «Кибер-ночь»
    public virtual string BgDefault     => "oklch(0.04 0.015 240)";  // near black with blue
    public virtual string BgSubtle      => "oklch(0.12 0.02 240)";
    public virtual string BgMuted       => "oklch(0.09 0.018 240)";
    public virtual string BgEmphasized  => "oklch(0.16 0.025 240)";
    public virtual string BgOverlay     => "oklch(0 0 0 / 0.80)";
    public virtual string BgGlass       => "oklch(0.04 0.015 240 / 0.7)";
    public virtual string BorderGlass   => "oklch(0.99 0 0 / 0.06)";
    public virtual string BlurGlass     => "20px";

    public virtual string Surface         => "oklch(0.08 0.02 240)";
    public virtual string SurfaceRaised   => "oklch(0.10 0.025 240)";
    public virtual string SurfaceOverlay  => "oklch(0.10 0.025 240)";

    public virtual string FgDefault   => "oklch(0.96 0.005 220)";
    public virtual string FgSubtle    => "oklch(0.80 0.01 220)";
    public virtual string FgMuted     => "oklch(0.55 0.015 220)";
    public virtual string FgDisabled  => "oklch(0.35 0.015 220)";
    public virtual string FgInverse   => "oklch(0.04 0.015 240)";
    public virtual string FgLink      => "oklch(0.70 0.26 200)";
    public virtual string FgLinkHover => "oklch(0.78 0.26 200)";

    public virtual string BorderDefault => "oklch(0.22 0.025 240)";
    public virtual string BorderSubtle  => "oklch(0.15 0.02 240)";
    public virtual string BorderStrong  => "oklch(0.28 0.03 240)";
    public virtual string BorderFocus   => "oklch(0.70 0.26 200)";
    public virtual string Divider       => "oklch(0.15 0.02 240)";

    public virtual string ColorPrimary        => "oklch(0.70 0.26 200)";
    public virtual string ColorPrimarySubtle  => "oklch(0.18 0.08 200)";
    public virtual string ColorPrimaryMuted   => "oklch(0.25 0.12 200)";
    public virtual string ColorPrimaryHover   => "oklch(0.78 0.26 200)";
    public virtual string ColorPrimaryActive  => "oklch(0.64 0.26 200)";
    public virtual string ColorPrimaryFg      => "oklch(0.04 0.015 240)";

    public virtual string ColorSuccess        => "oklch(0.62 0.18 160)";
    public virtual string ColorSuccessSubtle  => "oklch(0.16 0.05 160)";
    public virtual string ColorSuccessHover   => "oklch(0.68 0.18 160)";
    public virtual string ColorSuccessFg      => "oklch(0.04 0.015 240)";

    public virtual string ColorDanger         => "oklch(0.62 0.26 350)";
    public virtual string ColorDangerSubtle   => "oklch(0.18 0.08 350)";
    public virtual string ColorDangerHover    => "oklch(0.68 0.26 350)";
    public virtual string ColorDangerFg       => "oklch(0.04 0.015 240)";

    public virtual string ColorWarning        => "oklch(0.76 0.22 50)";
    public virtual string ColorWarningSubtle  => "oklch(0.20 0.06 50)";
    public virtual string ColorWarningHover   => "oklch(0.82 0.20 50)";
    public virtual string ColorWarningFg      => "oklch(0.04 0.015 240)";

    public virtual string ColorInfo           => "oklch(0.64 0.20 280)";
    public virtual string ColorInfoSubtle     => "oklch(0.18 0.06 280)";
    public virtual string ColorInfoHover      => "oklch(0.70 0.18 280)";
    public virtual string ColorInfoFg         => "oklch(0.04 0.015 240)";
    ...
    public virtual string FocusRing       => "0 0 0 2px oklch(0.04 0.015 240), 0 0 0 4px oklch(0.70 0.26 200)";
    public virtual string FocusRingDanger => "0 0 0 2px oklch(0.04 0.015 240), 0 0 0 4px oklch(0.62 0.26 350)";
