...
internal class ReaderSemanticLight : BaseLightConsistent
{
    public ReaderSemanticLight() : base(55) { }

    // Warm sepia — paper-toned, NOT pure white surfaces (unlike base)
    public override string BgDefault     => "oklch(0.90 0.025 55)";   // warm cream
    public override string BgSubtle      => "oklch(0.93 0.02 55)";
    public override string BgMuted       => "oklch(0.86 0.025 55)";
    public override string BgEmphasized  => "oklch(0.82 0.03 55)";
    public override string BgOverlay     => "oklch(0.16 0.02 55 / 0.30)";
    public override string BgGlass       => "oklch(0.90 0.025 55 / 0.7)";
    public override string BorderGlass   => "oklch(0.82 0.03 55 / 0.3)";

    public override string Surface         => "oklch(0.95 0.02 55)";
    public override string SurfaceRaised   => "oklch(0.93 0.025 55)";
    public override string SurfaceOverlay  => "oklch(0.93 0.025 55)";

    public override string FgDefault   => "oklch(0.12 0.02 55)";
    public override string FgSubtle    => "oklch(0.34 0.02 55)";
    public override string FgMuted     => "oklch(0.50 0.015 55)";
    public override string FgDisabled  => "oklch(0.66 0.01 55)";
    public override string FgInverse   => "oklch(0.90 0.025 55)";
    public override string FgLink      => "oklch(0.57 0.14 55)";
    public override string FgLinkHover => "oklch(0.50 0.14 55)";

    public override string BorderDefault => "oklch(0.82 0.025 55)";
    public override string BorderSubtle  => "oklch(0.88 0.02 55)";
    public override string BorderStrong  => "oklch(0.75 0.03 55)";
    public override string BorderFocus   => "oklch(0.57 0.14 55)";
    public override string Divider       => "oklch(0.88 0.02 55)";

    // Warm amber-brown primary
    public override string ColorPrimary        => "oklch(0.57 0.14 55)";
    public override string ColorPrimarySubtle  => "oklch(0.93 0.04 55)";
    public override string ColorPrimaryMuted   => "oklch(0.84 0.08 55)";
    public override string ColorPrimaryHover   => "oklch(0.50 0.14 55)";
    public override string ColorPrimaryActive  => "oklch(0.44 0.13 55)";
    public override string ColorPrimaryFg      => "oklch(0.95 0.02 55)";

    public override string ColorSuccess        => "oklch(0.58 0.10 120)";
    public override string ColorSuccessHover   => "oklch(0.52 0.10 120)";
    public override string ColorSuccessFg      => "oklch(0.12 0.02 55)";

    public override string ColorDanger         => "oklch(0.55 0.16 15)";
    public override string ColorDangerHover    => "oklch(0.50 0.16 15)";
    public override string ColorDangerFg       => "oklch(0.95 0.02 55)";

    public override string ColorWarning        => "oklch(0.72 0.14 55)";
    public override string ColorWarningHover   => "oklch(0.66 0.14 55)";
    public override string ColorWarningFg      => "oklch(0.12 0.02 55)";

    public override string ColorInfo           => "oklch(0.58 0.08 180)";
    public override string ColorInfoHover      => "oklch(0.52 0.08 180)";
    public override string ColorInfoFg         => "oklch(0.12 0.02 55)";
    ...
    public override string ShadowXs => "0 1px 1px 0 oklch(0.12 0.02 55 / 0.04)";
    public override string ShadowSm => "0 1px 2px 0 oklch(0.12 0.02 55 / 0.06), 0 1px 1px -1px oklch(0.12 0.02 55 / 0.06)";
    public override string ShadowMd => "0 2px 4px -1px oklch(0.12 0.02 55 / 0.08), 0 1px 2px -1px oklch(0.12 0.02 55 / 0.06)";
    public override string ShadowLg => "0 8px 16px -4px oklch(0.12 0.02 55 / 0.10), 0 2px 4px -2px oklch(0.12 0.02 55 / 0.06)";
    public override string ShadowXl => "0 16px 32px -8px oklch(0.12 0.02 55 / 0.14), 0 4px 8px -4px oklch(0.12 0.02 55 / 0.08)";
    ...
    public override string FocusRing       => "0 0 0 2px oklch(0.90 0.025 55), 0 0 0 4px oklch(0.57 0.14 55)";
    public override string FocusRingDanger => "0 0 0 2px oklch(0.90 0.025 55), 0 0 0 4px oklch(0.55 0.16 15)";
}
