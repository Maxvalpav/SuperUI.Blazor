...
internal class SolarisSemanticLight : IThemeSemantic
{
    // Light — warm cream (hue 50°)
    public virtual string BgDefault     => "oklch(0.99 0.005 50)";
    public virtual string BgSubtle      => "oklch(0.97 0.008 50)";
    public virtual string BgMuted       => "oklch(0.935 0.012 50)";
    public virtual string BgEmphasized  => "oklch(0.89 0.016 50)";
    public virtual string BgOverlay     => "oklch(0.15 0.02 50 / 0.40)";
    public virtual string BgGlass       => "oklch(0.99 0.005 50 / 0.7)";
    ...
    public virtual string FgDefault   => "oklch(0.14 0.02 50)";
    public virtual string FgSubtle    => "oklch(0.36 0.015 50)";
    public virtual string FgMuted     => "oklch(0.52 0.012 50)";
    public virtual string FgDisabled  => "oklch(0.68 0.008 50)";
    public virtual string FgInverse   => "oklch(0.99 0.005 50)";
    public virtual string FgLink      => "oklch(0.62 0.16 65)";
    public virtual string FgLinkHover => "oklch(0.56 0.16 65)";
    ...
    public virtual string BorderFocus   => "oklch(0.62 0.16 65)";
    public virtual string Divider       => "oklch(0.93 0.01 50)";

    public virtual string ColorPrimary        => "oklch(0.62 0.16 65)";
    public virtual string ColorPrimarySubtle  => "oklch(0.94 0.04 65)";
    public virtual string ColorPrimaryMuted   => "oklch(0.85 0.08 65)";
    public virtual string ColorPrimaryHover   => "oklch(0.56 0.16 65)";
    public virtual string ColorPrimaryActive  => "oklch(0.50 0.15 65)";
    ...
    public virtual string ColorSuccessHover   => "oklch(0.54 0.12 145)";
    public virtual string ColorSuccessFg      => "oklch(0.99 0 0)";

    public virtual string ColorDanger         => "oklch(0.55 0.20 18)";
    public virtual string ColorDangerSubtle   => "oklch(0.94 0.05 18)";
    public virtual string ColorDangerHover    => "oklch(0.50 0.20 18)";
    public virtual string ColorDangerFg       => "oklch(0.99 0 0)";

    public virtual string ColorWarning        => "oklch(0.70 0.16 50)";
    public virtual string ColorWarningSubtle  => "oklch(0.96 0.04 50)";
    public virtual string ColorWarningHover   => "oklch(0.64 0.16 50)";
    public virtual string ColorWarningFg      => "oklch(0.14 0.02 50)";

    public virtual string ColorInfo           => "oklch(0.58 0.14 35)";
    public virtual string ColorInfoSubtle     => "oklch(0.94 0.035 35)";
    public virtual string ColorInfoHover      => "oklch(0.52 0.14 35)";
    ...
    public virtual string ShadowLg => "0 8px 16px -4px oklch(0.14 0.02 50 / 0.10), 0 2px 4px -2px oklch(0.14 0.02 50 / 0.06)";
    public virtual string ShadowXl => "0 16px 32px -8px oklch(0.14 0.02 50 / 0.14), 0 4px 8px -4px oklch(0.14 0.02 50 / 0.08)";
    ...
    public virtual string FocusRing       => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.62 0.16 65)";
    public virtual string FocusRingDanger => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.55 0.20 18)";
