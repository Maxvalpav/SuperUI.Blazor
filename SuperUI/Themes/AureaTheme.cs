...
internal class AureaSemanticLight : IThemeSemantic
{
    ...
    public virtual string ColorInfo           => "oklch(0.58 0.14 272.5)";
    public virtual string ColorInfoSubtle     => "oklch(0.94 0.035 272.5)";
    public virtual string ColorInfoHover      => "oklch(0.52 0.14 272.5)";
