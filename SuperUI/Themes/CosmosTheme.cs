...
internal class CosmosSemanticLight : IThemeSemantic
{
    // Light — «Звёздный свет»
    public virtual string BgDefault     => "oklch(0.99 0.003 270)";
    public virtual string BgSubtle      => "oklch(0.97 0.005 270)";
    public virtual string BgMuted       => "oklch(0.935 0.008 270)";
    public virtual string BgEmphasized  => "oklch(0.89 0.012 270)";
    public virtual string BgOverlay     => "oklch(0.16 0.02 270 / 0.40)";
    public virtual string BgGlass       => "oklch(0.99 0.003 270 / 0.7)";
    public virtual string BorderGlass   => "oklch(0.87 0.015 270 / 0.3)";
    ...
    public virtual string FgDefault   => "oklch(0.14 0.015 270)";
    public virtual string FgSubtle    => "oklch(0.36 0.012 270)";
    public virtual string FgMuted     => "oklch(0.52 0.01 270)";
    public virtual string FgDisabled  => "oklch(0.68 0.008 270)";
    public virtual string FgInverse   => "oklch(0.99 0.003 270)";
    public virtual string FgLink      => "oklch(0.59 0.14 220)";
    public virtual string FgLinkHover => "oklch(0.53 0.14 220)";

    public virtual string BorderDefault => "oklch(0.87 0.012 270)";
    public virtual string BorderSubtle  => "oklch(0.93 0.01 270)";
    public virtual string BorderStrong  => "oklch(0.80 0.015 270)";
    public virtual string BorderFocus   => "oklch(0.59 0.14 220)";
    public virtual string Divider       => "oklch(0.93 0.01 270)";
    ...
    public virtual string ColorSuccess        => "oklch(0.58 0.14 335.9)";
    public virtual string ColorSuccessSubtle  => "oklch(0.94 0.04 335.9)";
    public virtual string ColorSuccessHover   => "oklch(0.52 0.14 335.9)";
    public virtual string ColorSuccessFg      => "oklch(0.99 0 0)";

    public virtual string ColorDanger         => "oklch(0.55 0.20 70.6)";
    public virtual string ColorDangerSubtle   => "oklch(0.94 0.05 70.6)";
    public virtual string ColorDangerHover    => "oklch(0.50 0.20 70.6)";
    public virtual string ColorDangerFg       => "oklch(0.99 0 0)";

    public virtual string ColorWarning        => "oklch(0.70 0.14 9.4)";
    public virtual string ColorWarningSubtle  => "oklch(0.96 0.04 9.4)";
    public virtual string ColorWarningHover   => "oklch(0.64 0.14 9.4)";
    public virtual string ColorWarningFg      => "oklch(0.14 0.015 270)";

    public virtual string ColorInfo           => "oklch(0.58 0.12 314.7)";
    public virtual string ColorInfoSubtle     => "oklch(0.94 0.03 314.7)";
    public virtual string ColorInfoHover      => "oklch(0.52 0.12 314.7)";
    ...
    public virtual string ShadowXs => "0 1px 1px 0 oklch(0.14 0.015 270 / 0.04)";
    public virtual string ShadowSm => "0 1px 2px 0 oklch(0.14 0.015 270 / 0.06), 0 1px 1px -1px oklch(0.14 0.015 270 / 0.06)";
    public virtual string ShadowMd => "0 2px 4px -1px oklch(0.14 0.015 270 / 0.08), 0 1px 2px -1px oklch(0.14 0.015 270 / 0.06)";
    public virtual string ShadowLg => "0 8px 16px -4px oklch(0.14 0.015 270 / 0.10), 0 2px 4px -2px oklch(0.14 0.015 270 / 0.06)";
    public virtual string ShadowXl => "0 16px 32px -8px oklch(0.14 0.015 270 / 0.14), 0 4px 8px -4px oklch(0.14 0.015 270 / 0.08)";
    ...
    public virtual string FocusRingDanger => "0 0 0 2px oklch(1 0 0), 0 0 0 4px oklch(0.55 0.20 70.6)";
